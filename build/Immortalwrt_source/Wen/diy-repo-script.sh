...
#passwall
#clone_or_update_git_repo https://github.com/xiaorouji/openwrt-passwall package/Wen/luci-app-passwall main luci-app-passwall
...
#subconverter
# git clone --depth=1 https://github.com/tindy2013/openwrt-subconverter package/Wen/subconverter
# git clone --depth=1 https://github.com/0x2196f3/luci-app-subconverter package/Wen/luci-app-subconverter
...
#tailscale
clone_or_update_git_repo https://github.com/BootLoopLover/pakalolo-package package/Wen/luci-app-tailscale "" applications/luci-app-tailscale
#lucky
